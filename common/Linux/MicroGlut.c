...
// Letters for classic game controls
		case 25: buffer[0] = GLUT_KEY_W; break;
		case 38: buffer[0] = GLUT_KEY_A; break;
		case 39: buffer[0] = GLUT_KEY_S; break;
		case 40: buffer[0] = GLUT_KEY_D; break;

// Adding Space for flying up and E for flying down
		case 65: buffer[0] = GLUT_STENCIL; break;
		case 26: buffer[0] = GLUT_KEY_E; break;
